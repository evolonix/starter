  ...
  return (
    <Headless.Dialog {...props}>
      <Headless.DialogBackdrop
        transition
        className="fixed inset-0 z-50 flex w-screen justify-center overflow-y-auto bg-zinc-950/15 px-2 py-2 transition duration-100 focus:outline-0 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50"
      />
...
export function AlertActions({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        'mt-6 flex flex-col items-center justify-start gap-3 *:w-full sm:mt-4 sm:flex-row-reverse sm:*:w-auto',
      )}
    />
  );
}
