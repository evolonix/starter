...
# Run with:
# docker run -it --rm -p 3000:3000 --name starter-web-preview --label com.docker.compose.project=starter web:preview
...
# Run with:
# docker run -it --rm -p 3000:3000 --name starter-web-staging --label com.docker.compose.project=starter web:staging
...
# Run with:
# docker run -it --rm -p 3000:3000 --name starter-web-production --label com.docker.compose.project=starter web:v$(npm --prefix apps/web pkg get version | tr -d '\"')
